package com.yomahub.liteflow.bean.sms.hw;
...
public class SendSms {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // APP_Key
        String appKey = "b3Yi11Tlsv9SMom9a8Ldekc7Ovv66";
        // APP_Secret
        String appSecret = "xsA5LNwrEqnkKCXq9cG7w9XfZ4ab6";
        // 国内短信签名通道号
        // String sender = "csms12345678";
        String sender = "cs106900001919";
        // 模板ID
        String templateId = "7974769000d34279ba2b1ae305b01cab6";

        // 条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
        
        // 签名名称
        String signature = "签名测试";

        // 必填,全局号码格式(包含国家码),示例:+8615123456789,多个号码之间用英文逗号分隔
        // String receiver = "+86151****6789,+86152****7890"; // 短信接收人号码
        String receiver = "+8615918762108," +
                // "+8613048898739," +
                "+8618551001272"; // 短信接收人号码
        ...
        // String templateParas ="[\"3361\",\"12345\",\"1124\",\"123456\"]";
